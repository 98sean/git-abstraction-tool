// WeeklyReport/renderer/components/DailyTimeline.tsx
// 요일별 커밋 횟수를 CSS 바 차트로 시각화

import React from 'react'
import { DailyBreakdown } from '../../types/weekly-report'
        ...
        {breakdown.map((day) => {
          ...
          return (
            <div key={day.date} className={`wr-timeline-col ${isToday ? 'wr-timeline-col--today' : ''}`}>
              <span className="wr-bar-count">
                {day.commitCount > 0 ? day.commitCount : ''}
              </span>
